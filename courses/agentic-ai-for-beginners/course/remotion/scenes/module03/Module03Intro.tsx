// Module 03 Intro: NVIDIA AI Platform Stack
import React from 'react';
import { useCurrentFrame, useVideoConfig, spring, interpolate } from 'remotion';
import { SceneProps, COLORS } from '../../shared/types';

interface Module03IntroProps extends SceneProps {}

export const Module03Intro: React.FC<Module03IntroProps> = ({
	durationInFrames,
	cuePoints = [],
}) => {
		...
		>
			...
			<div
				style={{
					...
					right: 0,
					bottom: 0,
					background: `radial-gradient(ellipse at ${50 + panX * 2}% ${50 + panY * 2}%, rgba(118, 185, 0, 0.12) 0%, transparent 55%)`,
					pointerEvents: 'none',
				}}
			/>
			...
			>
				...
				<h1
					style={{
						...
						lineHeight: 1.1,
						filter: `drop-shadow(0 0 ${glowIntensity}px rgba(118, 185, 0, 0.35))`,
					}}
				>
				...
				<div
					style={{
						...
						height: 6,
						background: `linear-gradient(90deg, #76b900 0%, #3b82f6 100%)`,
						margin: '50px auto',
						borderRadius: 3,
					}}
				/>
				...
				>
					From silicon to APIs. A unified platform for AI at scale.
				</p>
			</div>

			<div style={{ position: 'absolute', top: 40, left: 40, width: interpolate(lineSpring, [0, 1], [0, 80]), height: 3, background: '#76b900', opacity: 0.5 }} />
			<div style={{ position: 'absolute', top: 40, left: 40, width: 3, height: interpolate(lineSpring, [0, 1], [0, 80]), background: '#76b900', opacity: 0.5 }} />
