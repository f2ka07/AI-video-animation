...
export const Module1: React.FC = () => {
	...
	const module_1_titleSlide = addSlide(audioDurations["module-1-title"]);
	const module_1_conceptSlide = addSlide(audioDurations["module-1-concept"]);
	const module_1_architectureSlide = addSlide(audioDurations["module-1-architecture"]);
	const module_1_applicationSlide = addSlide(audioDurations["module-1-application"]);
	const module_1_exam_mappingSlide = addSlide(audioDurations["module-1-exam-mapping"]);
	const module_1_recapSlide = addSlide(audioDurations["module-1-recap"], true, 0.5);
	...
	return (
		...
		>
			...
			>
					...
					audioDuration={audioDurations["module-1-title"]}
				/>
				</CrossFadeWrapper>
			</Sequence>
			{/* Whoosh transition */}
			<Sequence
				from={module_1_titleSlide.start + module_1_titleSlide.audioDuration * fps}
			...
			>
					...
					audioDuration={audioDurations["module-1-concept"]}
			/>
				</CrossFadeWrapper>
			</Sequence>
			{/* Whoosh transition */}
			<Sequence
				from={module_1_conceptSlide.start + module_1_conceptSlide.audioDuration * fps}
				durationInFrames={whooshDuration * fps}
			>
				<Audio src={audioFiles.whoosh} startFrom={0} />
			</Sequence>
			...
			>
					...
					audioDuration={audioDurations["module-1-architecture"]}
			/>
				</CrossFadeWrapper>
			</Sequence>
			{/* Whoosh transition */}
			<Sequence
				from={module_1_architectureSlide.start + module_1_architectureSlide.audioDuration * fps}
				durationInFrames={whooshDuration * fps}
			>
				<Audio src={audioFiles.whoosh} startFrom={0} />
			</Sequence>
			...
			>
					...
					audioDuration={audioDurations["module-1-application"]}
			/>
				</CrossFadeWrapper>
			</Sequence>
			{/* Whoosh transition */}
			<Sequence
				from={module_1_applicationSlide.start + module_1_applicationSlide.audioDuration * fps}
				durationInFrames={whooshDuration * fps}
			>
				<Audio src={audioFiles.whoosh} startFrom={0} />
			</Sequence>
			...
			>
					...
					audioDuration={audioDurations["module-1-exam-mapping"]}
			/>
				</CrossFadeWrapper>
			</Sequence>
			{/* Whoosh transition */}
			<Sequence
				from={module_1_exam_mappingSlide.start + module_1_exam_mappingSlide.audioDuration * fps}
				durationInFrames={whooshDuration * fps}
			>
				<Audio src={audioFiles.whoosh} startFrom={0} />
			</Sequence>
			...
			>
					...
					audioDuration={audioDurations["module-1-recap"]}
			/>
				</CrossFadeWrapper>
			</Sequence>
