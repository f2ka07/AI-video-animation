...
export const Module1: React.FC = () => {
	...
	return (
		...
		{/* Audio: module1-module-1-concept */}
		<Sequence
			from={1319}
		...
		{/* Audio: module1-module-1-architecture */}
		<Sequence
			from={4324}
		...
		{/* Audio: module1-module-1-application */}
		<Sequence
			from={7882}
		...
		{/* Audio: module1-module-1-exam-mapping */}
		<Sequence
			from={10410}
