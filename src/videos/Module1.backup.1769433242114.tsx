...
export const Module1: React.FC = () => {
	...
	return (
		...
		>
			<Module01Diagram1
				durationInFrames={2987}
				cuePoints={[187, 464, 692, 693, 770, 857, 1393, 1490, 1835, 1925, 1935, 2007, 2164, 2167, 2330, 2404, 2470, 2579, 2751, 2826, 2888, 2963]}
			/>
			<Audio src={audioFiles["module1-module-1-concept"]} />
		</Sequence>

		{/* Transition */}
		<Sequence from={4291} durationInFrames={18}>
			<Audio src={audioFiles.whoosh} />
		</Sequence>
		...
		>
			<Module01Diagram2
				durationInFrames={3540}
				cuePoints={[128, 170, 213, 241, 389, 547, 584, 784, 786, 853, 1000, 1016, 1078, 1080, 1401, 1733, 1755, 1787, 1808, 1900, 2002, 2143, 2233, 2312, 2385, 2447, 2518, 2582, 2659, 2718, 2814, 2896, 2960, 3027, 3090, 3207, 3264, 3341, 3403, 3465]}
			/>
			<Audio src={audioFiles["module1-module-1-architecture"]} />
		</Sequence>

		{/* Transition */}
		<Sequence from={7849} durationInFrames={18}>
			<Audio src={audioFiles.whoosh} />
		</Sequence>
		...
		>
			<Module01Diagram3
				durationInFrames={2510}
				cuePoints={[0, 70, 120, 162, 165, 166, 195, 237, 346, 390, 490, 561, 562, 640, 878, 1236, 1403, 1426, 1577, 1681, 1789, 1896, 1965, 2035, 2105, 2163, 2259, 2330, 2416]}
			/>
			<Audio src={audioFiles["module1-module-1-application"]} />
		</Sequence>

		{/* Transition */}
		<Sequence from={10377} durationInFrames={18}>
			<Audio src={audioFiles.whoosh} />
		</Sequence>
		...
		>
			<Module01Recap
				durationInFrames={1349}
				cuePoints={[0, 39, 115, 189, 243, 313, 388, 451, 509, 613, 685, 2205, 2216, 2226, 2237, 2247]}
			/>
