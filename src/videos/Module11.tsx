...
export const Module11: React.FC = () => {
	...
	const audioFiles = {
		title: staticFile("audio/module11-title.wav"),
		vpcPeeringBasics: staticFile("audio/module11-vpcPeeringBasics.wav"),
		createVPCPeering: staticFile("audio/module11-createVPCPeering.wav"),
		transitGatewayBasics: staticFile("audio/module11-transitGatewayBasics.wav"),
		createTransitGateway: staticFile("audio/module11-createTransitGateway.wav"),
		summary: staticFile("audio/module11-summary.wav"),
		whoosh: staticFile("audio/whoosh.wav"),
	};

	const audioDurations = {
		title: getAudioDuration("module11-title"),
		vpcPeeringBasics: getAudioDuration("module11-vpcPeeringBasics"),
		createVPCPeering: getAudioDuration("module11-createVPCPeering"),
		transitGatewayBasics: getAudioDuration("module11-transitGatewayBasics"),
		createTransitGateway: getAudioDuration("module11-createTransitGateway"),
		summary: getAudioDuration("module11-summary"),
	};
	...
	const vpcPeeringBasicsSlide = addSlide(audioDurations["vpcPeeringBasics"]);
	const createVPCPeeringSlide = addSlide(audioDurations["createVPCPeering"]);
	const transitGatewayBasicsSlide = addSlide(audioDurations["transitGatewayBasics"]);
	const createTransitGatewaySlide = addSlide(audioDurations["createTransitGateway"]);
	...
	return (
		...
		>
			...
			>
					<TitleSlide title="Advanced Networking Patterns" subtitle="Module 11: VPC Peering and Transit Gateway" />
				</CrossFadeWrapper>
			</Sequence>
			{/* Whoosh transition */}
			<Sequence
			...
			>
					...
					audioDuration={audioDurations["vpcPeeringBasics"]}
				/>
				</CrossFadeWrapper>
			</Sequence>
			{/* Whoosh transition */}
			<Sequence
				from={vpcPeeringBasicsSlide.start + vpcPeeringBasicsSlide.audioDuration * fps}
				durationInFrames={whooshDuration * fps}
			>
				<Audio src={audioFiles.whoosh} startFrom={0} />
			</Sequence>
...
const vpc2Route = new aws.ec2.Route("vpc2-to-vpc1", {
    ...
    vpcPeeringConnectionId: peering.id,
				...
				moduleNumber={11}
				audioDuration={audioDurations["createVPCPeering"]}
		/>
				</CrossFadeWrapper>
			</Sequence>
			{/* Whoosh transition */}
			<Sequence
				from={createVPCPeeringSlide.start + createVPCPeeringSlide.audioDuration * fps}
				durationInFrames={whooshDuration * fps}
			>
				<Audio src={audioFiles.whoosh} startFrom={0} />
			</Sequence>
			...
			>
					...
					imageSrc="assets/vpc.svg"
					audioDuration={audioDurations["transitGatewayBasics"]}
				/>
				</CrossFadeWrapper>
			</Sequence>
			{/* Whoosh transition */}
			<Sequence
				from={transitGatewayBasicsSlide.start + transitGatewayBasicsSlide.audioDuration * fps}
				durationInFrames={whooshDuration * fps}
			>
				<Audio src={audioFiles.whoosh} startFrom={0} />
			</Sequence>
...
const vpc1ToVpc2Route = new aws.ec2.Route("vpc1-to-vpc2-via-tgw", {
    ...
    transitGatewayId: tgw.id,
				...
				moduleNumber={11}
				audioDuration={audioDurations["createTransitGateway"]}
		/>
				</CrossFadeWrapper>
			</Sequence>
			{/* Whoosh transition */}
			<Sequence
				from={createTransitGatewaySlide.start + createTransitGatewaySlide.audioDuration * fps}
				durationInFrames={whooshDuration * fps}
			>
				<Audio src={audioFiles.whoosh} startFrom={0} />
			</Sequence>
