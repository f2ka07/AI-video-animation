	...
	return (
		...
		>
			<Module02Intro
				...
				cuePoints={[0, 37]}
			/>
			<Audio src={audioFiles["module2-module-2-title"]} startFrom={0} />
		</Sequence>
		...
		>
			<Module02Diagram1
				durationInFrames={2076}
				cuePoints={[0, 155, 202, 343, 834, 1125, 1175, 1647, 1698, 1735, 1843, 1846, 2022]}
			/>
			<Audio src={audioFiles["module2-module-2-concept"]} startFrom={0} />
		</Sequence>
		...
		>
			...
			/>
			<Audio src={audioFiles["module2-module-2-architecture"]} startFrom={0} />
		</Sequence>
		...
		>
			<Module02Diagram3
				durationInFrames={2603}
				cuePoints={[0, 899, 1822, 1892, 2023, 2054, 2091, 2110, 2191, 2314, 2357, 2404, 2477, 2535]}
			/>
			<Audio src={audioFiles["module2-module-2-application"]} startFrom={0} />
		</Sequence>
		...
		>
			<Module02Recap
				durationInFrames={4061}
				cuePoints={[0, 17, 473, 772, 1873, 1948, 2061, 2092, 2178, 2216, 2259, 2323, 2428, 2496, 2534, 2587, 2680, 2836, 2885, 2983, 3078, 3144, 3228, 3302, 3403, 3477, 3560, 3661, 3756, 3831, 3895, 3979]}
			/>
			<Audio src={audioFiles["module2-module-2-exam-mapping"]} startFrom={0} />
			<Audio src={audioFiles["module2-module-2-recap"]} startFrom={2093} />
		</Sequence>
		</div>
	);
};
