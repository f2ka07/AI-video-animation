...
export const Module2: React.FC = () => {
	...
	return (
		...
		{/* Audio: module2-module-2-concept */}
		<Sequence
			from={1562}
		...
		{/* Audio: module2-module-2-architecture */}
		<Sequence
			from={3656}
		...
		{/* Audio: module2-module-2-application */}
		<Sequence
			from={10209}
		...
		{/* Audio: module2-module-2-exam-mapping */}
		<Sequence
			from={12830}
