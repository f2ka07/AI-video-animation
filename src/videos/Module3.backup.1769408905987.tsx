...
export const Module3: React.FC = () => {
	...
	return (
		...
		>
			...
			/>
			<Audio src={audioFiles["module3-module-3-title"]} startFrom={0} />
		</Sequence>
		...
		>
			...
			/>
			<Audio src={audioFiles["module3-module-3-concept"]} startFrom={0} />
		</Sequence>
		...
		>
			...
			/>
			<Audio src={audioFiles["module3-module-3-architecture"]} startFrom={0} />
		</Sequence>
		...
		>
			...
			/>
			<Audio src={audioFiles["module3-module-3-application"]} startFrom={0} />
		</Sequence>
		...
		>
			...
			/>
			<Audio src={audioFiles["module3-module-3-exam-mapping"]} startFrom={0} />
			<Audio src={audioFiles["module3-module-3-recap"]} startFrom={2228} />
		</Sequence>
		</div>
	);
};
