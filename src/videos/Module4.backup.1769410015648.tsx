...
export const Module4: React.FC = () => {
	...
	return (
		...
		{/* Audio: module4-module-4-concept */}
		<Sequence
			from={1708}
		...
		{/* Audio: module4-module-4-architecture */}
		<Sequence
			from={5358}
		...
		{/* Audio: module4-module-4-application */}
		<Sequence
			from={11879}
		...
		{/* Audio: module4-module-4-exam-mapping */}
		<Sequence
			from={15808}
