...
export const Module4: React.FC = () => {
	...
	return (
		...
		>
			<Module04Intro
				durationInFrames={1690}
				cuePoints={[0, 12, 26, 42, 63, 88, 101, 115, 139, 147, 158, 173, 184, 195, 203, 232, 237, 244, 252, 265, 293, 307, 332, 339, 358]}
			/>
		...
		>
			<Module04Diagram1
				durationInFrames={3632}
				cuePoints={[0, 8, 24, 79, 164, 256, 316, 383, 467, 535, 625, 721, 795, 895, 968, 1018, 1065, 1132, 1258, 1333, 1383, 1428, 1516, 1557, 1613, 1685, 1785, 1849, 1938, 2025, 2111, 2203, 2307, 2416, 2486, 2557, 2625, 2690, 2774, 2861, 2969, 3071, 3176, 3246]}
			/>
		...
		>
			<Module04Diagram2
				durationInFrames={6503}
				cuePoints={[0, 41, 117, 190, 266, 341, 438, 496, 578, 638, 725, 790, 870, 922, 994, 1061, 1144, 1182, 1279, 1328, 1403, 1446, 1528, 1566, 1622, 1702, 1813, 1882, 1934, 2008, 2120, 2170, 2254, 2317, 2422, 2524, 2593, 2679, 2780, 2836, 2892, 2941, 2995, 3075, 3133, 3221, 3310, 3358, 3484, 3549, 3624, 3725, 3781, 3870, 3922, 3990, 4080, 4135, 4171, 4279, 4344, 4417, 4488, 4543, 4618, 4747, 4818, 4886, 4972, 5039, 5099, 5170, 5206, 5284, 5338, 5393, 5499, 5603, 5658, 5746, 5845, 5973, 6063, 6116, 6225, 6295, 6350]}
			/>
		...
		>
			<Module04Diagram3
				durationInFrames={3911}
				cuePoints={[98, 128, 177, 205, 232, 403, 418, 481, 538, 556, 598, 625, 671, 704, 736, 792, 793, 896, 1036, 1088, 1120, 1175, 1197, 1261, 1266, 1798, 1891, 2679, 2738, 3001, 3319, 3522, 3563, 3588]}
			/>
		...
		<Sequence
			from={15808}
			durationInFrames={2227}
		>
			<Module04Recap
				durationInFrames={2227}
				cuePoints={[0, 20, 123, 155, 245, 260, 261, 309, 335, 356, 359, 517, 558, 1479, 1605, 1725, 1867, 1980, 2024, 2178, 2224, 2226, 2605, 3041, 3043, 3044, 3045, 3077, 3157, 3207, 3242, 3342, 3407, 3486, 3586, 3693, 3800, 3864, 3912, 3978, 4052, 4114, 4175, 4243, 4307]}
			/>
