...
export const Module6: React.FC = () => {
	...
	return (
		...
		{/* Audio: module6-module-6-concept */}
		<Sequence
			from={1721}
		...
		{/* Audio: module6-module-6-architecture */}
		<Sequence
			from={4417}
		...
		{/* Audio: module6-module-6-application */}
		<Sequence
			from={9781}
		...
		{/* Audio: module6-module-6-exam-mapping */}
		<Sequence
			from={14229}
