...
// Generated: 2026-01-26T02:02:09.053Z

export interface SlideContent {
	name: string;
	type: "title" | "content-two-card" | "content-single" | "code" | "code-diagram" | "comparison" | "sequential-bullet";
	script: string;
	title?: string;
	subtitle?: string;
	points?: string[];
	...
	language?: string;
	imageSrc?: string;
	svgPath?: string; // For sequential-bullet slides with SVG on right
...
export interface ModuleContent {
	...
	subtitle: string;
	slides: SlideContent[];
	videoCategory?: "standard" | "short"; // "standard" = landscape 1920x1080, "short" = portrait 1080x1920 with 5s slides
}
