...
// Restored: 2026-01-31T10:42:13.623Z
	...
	slides: [
		{
			...
			type: "title",
			script: "Wireless networks let devices communicate without wires, using radio waves. This module explores what wireless networks are, why they matter, and the basic components involved. You will learn how wireless technology connects us seamlessly in everyday life.",
			title: "Introduction to Wireless Networks",
			points: [
				"Wireless networks use radio waves",
				"Devices communicate without wires",
				"Basic components involved",
				"Wireless technology connects us"
			]
		},
		{
			...
			points: [
				...
				"Enable connection anywhere",
				"Power modern communication",
				"Support smart homes and IoT"
			]
		},
		{
			...
			points: [
				"Access points broadcast signals",
				"Client devices connect",
				"Routers manage traffic",
				"Parts create wireless environment"
			]
		},
		{
		...
		},
		{
			...
			points: [
				"Runs command-line Wi-Fi scan",
				"Captures and decodes output",
				"Separates network names",
				"Prints each discovered network"
			]
		},
		{
